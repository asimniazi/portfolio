    ...
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <div className="container">
        ...
        <div className="nav-socials">
          <a href="https://github.com/asimniazi" target="_blank" rel="noreferrer" title="GitHub">
          ...
          <a href="https://www.linkedin.com/in/i-am-asim-khan" target="_blank" rel="noreferrer" title="LinkedIn">
